...
function ThemeProvider(t0) {
    ...
    if ($[0] !== "7a3af1fc00fd5f379a321144423fdc91ee8b628d5b0db90ac584fccbf3d81e7e") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "7a3af1fc00fd5f379a321144423fdc91ee8b628d5b0db90ac584fccbf3d81e7e";
    }
    let children;
    let props;
    if ($[1] !== t0) {
...
function RootLayout(t0) {
    ...
    if ($[0] !== "00c7cf5fc1929824aa4ca481a32843b970a636b83d3bd34455eaddd0d7938830") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "00c7cf5fc1929824aa4ca481a32843b970a636b83d3bd34455eaddd0d7938830";
    }
    const { children } = t0;
    let t1;
    if ($[1] !== children) {
...
//# sourceMappingURL=_eeecdec0._.js.map